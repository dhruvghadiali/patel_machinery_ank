...
import ServicesDialogComponent from "@ScreenComponents/services/servicesDialogComponent";
...
const ServicesSectionCardComponent = ({ service, visibleCards, index }) => {
  ...
  //       detailedDescription:
  //         "Our comprehensive pile testing services ensure the structural integrity and load-bearing capacity of installed piles. Using state-of-the-art equipment and internationally recognized testing methods, we provide accurate assessment and certification for your foundation systems.",
  //       process: [
